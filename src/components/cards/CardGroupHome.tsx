...
export default function CardGroupHome(){
    return <div className="absolute flex flex-row  self-center gap-8 top-86  h-auto z-10">
        <Card2 className=" mb-20" title="95%" subtitle="Improved Eating Habits" image={groceryBagPic2} ></Card2>
        ...
        <Card2 className=" mb-20" image={HerbPic1}></Card2>
    </div>
}